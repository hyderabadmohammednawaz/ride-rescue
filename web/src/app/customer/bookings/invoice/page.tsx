  ...
  return (
    <div className="mx-auto max-w-3xl">
      <div className="mb-4 flex items-center justify-between no-print">
        <Link href={`/customer/bookings/detail?id=${id}`} className="text-sm text-brand-600 hover:underline dark:text-brand-400">
          ← Back to booking
        </Link>
...
export default function InvoicePage() {
  return (
    <Suspense fallback={<Spinner label="Preparing invoice…" />}>
      <InvoiceContent />
    </Suspense>
  );
}
